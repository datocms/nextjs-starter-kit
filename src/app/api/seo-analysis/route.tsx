...
/*
 * Import the generated types for your DatoCMS models.
 * These are generated by running `npm run generate-cma-types`.
 * See: https://www.datocms.com/docs/content-management-api/resources/item#use-generated-types
 */
import type { Page } from '@/lib/datocms/cma-types';
...
export async function GET(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    /*
     * Fetch the record with the generated type for full type safety.
     * This is the DatoCMS-recommended approach:
     * https://www.datocms.com/docs/content-management-api/resources/item#use-generated-types
     *
     * The generic parameter <Page> tells TypeScript exactly what fields
     * this record has, giving you autocomplete and compile-time safety.
     */
    const { data: item } = await client.items.rawFind<Page>(itemId);
