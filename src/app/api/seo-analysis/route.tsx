...
export async function GET(request: NextRequest): Promise<NextResponse> {
  try {
    ...
    /*
     * Fetch the record using generated types for full type safety.
     ...
     *
     * Adding a generic parameter <AnyModel> to the method call tells TypeScript
     * exactly what fields this record has, giving you autocomplete and
     * compile-time safety.
     */
